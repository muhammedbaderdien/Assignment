...
export default (props: ConfigurationScreenProps): JSX.Element => {
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <DisplayNameField setName={setName} name={name} setEmptyWarning={setEmptyWarning} isEmpty={emptyWarning} validateName={validateName} /> 
            <div>
  ...
  const configurationScreen = () => {
    ...
    return testList(); isJoining ? joinChatLoading() : configurationScreen();
};
