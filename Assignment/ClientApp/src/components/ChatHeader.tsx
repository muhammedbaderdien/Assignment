...
import { UserFriendsIcon, SettingsIcon, ChatIcon } from '@fluentui/react-icons-northstar';
...
export default (props: ChatHeaderProps): JSX.Element => {
  const togglePivotItem = (item: PivotItem | undefined) => {
    ...
    if (item.props.itemKey === SidePanelTypes.Chat)
  ...
  const toggleChat = (
    ...
    return selectedPane !== SidePanelTypes.Chat
      ? setSelectedPane(SidePanelTypes.Chat)
      : setSelectedPane(SidePanelTypes.None);
  };
        ...
        <Stack horizontal={true}>
          <Stack.Item align="center">
            ...
            >
              ...
              />
              {/* To Toggle Chat's Panel */}
              <PivotItem
                itemKey={SidePanelTypes.Chat}
                onRenderItemLink={() => (
                  <ChatIcon
                    outline={
                      props.selectedPane === SidePanelTypes.Chat
                        ? false
                        : true
                    }
                    size="medium"
